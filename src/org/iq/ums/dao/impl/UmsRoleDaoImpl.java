...
public class UmsRoleDaoImpl extends BaseDaoImpl implements UmsRoleDao {
	...
	private static final String SELECT_APP_ROLES = "SELECT ROLE_ID, ROLE_NAME, ROLE_DESCRIPTION, ROLE_AREA, ROLE_STATUS, ADDITIONAL_ID, ROLE_CREATION_TIME, ROLE_CREATED_BY, ROLE_UPDATED_TIME, ROLE_UPDATED_BY FROM UMS_ROLE WHERE ROLE_AREA = "+AreaSpecifier.APPLICATION.getAreaSpecifierValue();
