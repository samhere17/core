...
public class UpdateOptionService extends BaseService {
	...
	public void execute(HashMap<String, Object> input) throws ServiceException {
		...
		try {
			new UmsOptionHelper().updateOption(optionId, optionName, optionDescription, optionTypeValue,
					optionStatusValue, optionLink, optionIcon, optionOrder, parentOptionId, enableToolbox,
					objectReferenceKey);
