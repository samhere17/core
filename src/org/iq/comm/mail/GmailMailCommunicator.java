...
public class GmailMailCommunicator extends MailCommunicator {
	...
	private static String username = SystemContext.systemConfig.getMailUsername();
	private static String password = SystemContext.systemConfig.getMailPassword();
	private static String smtpAuthFlag = SystemContext.systemConfig.getMailSmtpAuthFlag();
	private static String smtpTLSEnableFlag = SystemContext.systemConfig.getMailSmtpTLSEnableFlag();
	private static String smtpHost = SystemContext.systemConfig.getMailSmtpHost();
	private static String smtpPort = SystemContext.systemConfig.getMailSmtpPort();
