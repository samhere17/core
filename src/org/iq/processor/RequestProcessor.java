...
public class RequestProcessor extends BaseProcessor {
	...
	private boolean isSessionCheckRequired() {
		...
		return ServiceConstants.AUTHENTICATION_SERVICE_NAME
				.equals(requestedServiceName) == false && ServiceConstants.REGISTRATION_SERVICE_NAME
						.equals(requestedServiceName) == false;
	}
	 ...
	 * @return
	 */
	public Map<? extends String, ? extends Object> processSystemRequest(
