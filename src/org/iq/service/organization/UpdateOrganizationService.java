...
@Service(name="UpdateOrganization")
public class UpdateOrganizationService extends BaseService {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2749712251741126636L;
	...
	public void execute(HashMap<String, Object> input) throws ServiceException {
		...
		int organizationId = Integer.valueOf(StringUtil.getStringValue(input.get(OrganizationParamKeys.ORGANIZATION_ID_KEY)));
...
//		Organization organization =  new Organization();
		try {
			...
			/*organization = */new OrganizationHelper().updateOrganization(organizationId,organizationName,
...
//		redirectUrl = "__sys/org/details.jsp";
		...
		redirectUrl = "adapter?serviceName=GetOrganization&path=__sys/org/details&orgId="+organizationId;
