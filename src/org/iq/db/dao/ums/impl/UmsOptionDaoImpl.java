...
public class UmsOptionDaoImpl extends BaseDaoImpl implements UmsOptionDao {
	...
	private static final String SELECT_ALL = "SELECT OPTION_ID, OPTION_NAME, OPTION_DESCRIPTION, OPTION_TYPE, OPTION_STATUS, OPTION_LINK, OPTION_IMAGE_LINK, OPTION_IMAGE_ALT, OPTION_ORDER, PARENT_OPTION_ID, ENABLE_TOOLBOX, OBJECT_REFERENCE_KEY FROM UMS_OPTION ORDER BY PARENT_OPTION_ID, OPTION_ORDER";
	private static final String SELECT_PARENT_OPTIONS = "SELECT OPTION_ID, OPTION_NAME, OPTION_DESCRIPTION, OPTION_TYPE, OPTION_STATUS, OPTION_LINK, OPTION_IMAGE_LINK, OPTION_IMAGE_ALT, OPTION_ORDER, PARENT_OPTION_ID, ENABLE_TOOLBOX, OBJECT_REFERENCE_KEY FROM UMS_OPTION WHERE OPTION_TYPE = "
			+ OptionType.MENU.getOptionTypeValue() + " ORDER BY OPTION_ORDER";
	private static final String SELECT_ACTIVE_PARENT_OPTIONS = "SELECT OPTION_ID, OPTION_NAME, OPTION_DESCRIPTION, OPTION_TYPE, OPTION_STATUS, OPTION_LINK, OPTION_IMAGE_LINK, OPTION_IMAGE_ALT, OPTION_ORDER, PARENT_OPTION_ID, ENABLE_TOOLBOX, OBJECT_REFERENCE_KEY FROM UMS_OPTION WHERE OPTION_TYPE = "
			+ OptionType.MENU.getOptionTypeValue() + " AND OPTION_STATUS = "+OptionStatus.ACTIVE.getOptionStatusValue()+" ORDER BY OPTION_ORDER";
	private static final String SELECT_BY_PARENT_OPTION_ID = "SELECT OPTION_ID, OPTION_NAME, OPTION_DESCRIPTION, OPTION_TYPE, OPTION_STATUS, OPTION_LINK, OPTION_IMAGE_LINK, OPTION_IMAGE_ALT, OPTION_ORDER, PARENT_OPTION_ID, ENABLE_TOOLBOX, OBJECT_REFERENCE_KEY FROM UMS_OPTION WHERE PARENT_OPTION_ID = ? ORDER BY OPTION_ORDER";
	private static final String SELECT_ACTIVE_BY_PARENT_OPTION_ID = "SELECT OPTION_ID, OPTION_NAME, OPTION_DESCRIPTION, OPTION_TYPE, OPTION_STATUS, OPTION_LINK, OPTION_IMAGE_LINK, OPTION_IMAGE_ALT, OPTION_ORDER, PARENT_OPTION_ID, ENABLE_TOOLBOX, OBJECT_REFERENCE_KEY FROM UMS_OPTION WHERE OPTION_STATUS = "+OptionStatus.ACTIVE.getOptionStatusValue()+" AND PARENT_OPTION_ID = ? ORDER BY OPTION_ORDER";
	private static final String SELECT_LAST_OPTION_ID = "SELECT MAX(OPTION_ID) AS OPTION_ID FROM UMS_OPTION";
	
	private static final String SELECT_BY_OPTION_ID = "SELECT OPTION_ID, OPTION_NAME, OPTION_DESCRIPTION, OPTION_TYPE, OPTION_STATUS, OPTION_LINK, OPTION_IMAGE_LINK, OPTION_IMAGE_ALT, OPTION_ORDER, PARENT_OPTION_ID, ENABLE_TOOLBOX, OBJECT_REFERENCE_KEY FROM UMS_OPTION WHERE OPTION_ID = ?";
...
//	private static final String UMS_USER_UPDATE_PASSWORD_BY_USER_ACCESS_KEY = "UPDATE UMS_USER SET PASSWORD=? WHERE USER_ACCESS_KEY = ?";
	...
	OPTION_ID, OPTION_NAME, OPTION_DESCRIPTION, OPTION_TYPE, OPTION_STATUS, OPTION_LINK, OPTION_IMAGE_LINK, OPTION_IMAGE_ALT, OPTION_ORDER, PARENT_OPTION_ID, ENABLE_TOOLBOX, OBJECT_REFERENCE_KEY
