		...
		<div class="panel-body">
			<div class="row">
				...
				<div class="col-md-6 form-group">
					...
					<input class="form-control" type="text" value="${user.userAccessKey}" readonly>
				</div>
				<div class="col-md-3 form-group">
			...
			<div class="row">
				...
				<div class="col-md-3 form-group">
					...
					<input class="form-control" type="text" value='<fmt:formatDate pattern="MMM dd" type="date" value="${userDetails.dateOfBirth}"/>' readonly>
				</div>
				<div class="col-md-3 form-group">
		...
		<div class="panel panel-danger">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-3 form-group">
						<label class="control-label" for="userId">Created By</label>
				...
				<div class="row">
					...
					<div class="col-md-3 form-group">
						<label class="control-label" for="userId">Last Updated By</label>
